...
extern void ternary_gemv_phase5_halo_launch(const void*, const void*, float,
                                            const void*, void*, int, int, void*);
extern void ternary_gemv_phase5_halo_f16_launch(const void*, const void*, float,
                                                const void*, void*, int, int, void*);
extern void ternary_gemv_sherry_f16_launch(const void*, const void*, float,
                                           const void*, void*, int, int, void*);
extern void ternary_gemv_tq1_halo_f16_launch(const void*, const void*, float,
                                             const void*, void*, int, int, void*);
...
rcpp_ternary_gemv_sherry_f16(const void* packed, const void* x_i8, float x_scale,
    ...
    if(!packed || !x_i8 || !row_scales || !y_f16) return RCPP_INVALID_ARG;
    if(M <= 0 || K <= 0)                          return RCPP_INVALID_ARG;
    if(K % 32 != 0)                               return RCPP_INVALID_ARG;  // macro-group boundary
...
rcpp_ternary_gemv_tq1_halo_f16(const void* packed, const void* x_i8, float x_scale,
    ...
    if(K_padded % 20 != 0)                        return RCPP_INVALID_ARG;  // 20 weights/u32
